...
RefLink[NumberQ,paclet:ref/NumberQ] test:"], 
 ...
 TapTestSameBROKEN[f[2], 0.451948], TapTestSameBROKEN[f[(1 + Sqrt[2])/5], 
  0.0135768], TapTestSame[f[a], f[a]], 
 TapComment["Replace negative numbers with zero:"], 
 ...
 TapTestSameBROKEN[f[0, 3], 0], TapTestSame[f[2, 4], f[2, 4]], 
 TapTestSame[f[-1, 3], f[-1, 3]], TapTestSameBROKEN[f[-2], 1/4], 
 TapTestSame[f[2], f[2]], TapTestSame[f[-4], f[-4]], 
 TapComment[
