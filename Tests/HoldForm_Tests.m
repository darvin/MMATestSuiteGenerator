...
expression by applying RefLink[ReleaseHold,paclet:ref/ReleaseHold]:"], 
 TapTestSameBROKEN[ReleaseHold[%], 285335317058486027411405324166464744463360\
46000259807132996794946525068955782076497004808203563331507532139984898857369\
6], TapComment["Show a formula and its evaluation: "], 
