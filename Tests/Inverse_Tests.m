...
TapSuite[TapComment["Inverse of a 2*2 matrix:"], 
 TapTestSameBROKEN[Inverse[{{1.4, 2}, {3, -6.7}}], 
  {{0.435631, 0.130039}, {0.195059, -0.0910273}}], 
 TapComment["Enter the matrix in a grid:"], 
 ...
 TapTestSameBROKEN[MatrixForm[Inverse[HilbertMatrix[5]]], 
  25 - 300*1050 - 1400*630 - 300*4800 - 18900*26880 - 12600*1050 - 
   ...
   12600*56700 - 88200*44100], TapTestSameBROKEN[
  HoldComplete[ArrayPlot[Inverse[HilbertMatrix[15]], Mesh -> True]], 
  $Failed], TapComment["Plot the imaginary parts of a Vandermonde matrix for \
a discrete Fourier transform: "], TapTestSameBROKEN[
 ...
 TapTestSameBROKEN[HoldComplete[
  ...
  $Failed], TapTestSameBROKEN[Inverse[m] . m, 
