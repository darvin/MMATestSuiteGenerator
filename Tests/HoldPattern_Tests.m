...
TapSuite[TapComment[
 ...
 TapComment["Use the pattern:"], TapTestSame[a + b /. %, 0], 
 TapComment["Make a definition without the argument of f being evaluated:"], 
 TapTestSame[f[HoldPattern[_ + _]] := 0; f[a + b], 0], 
 TapComment["RefLink[Log,paclet:ref/Log][a,b] autoevaluates to \
