...
TapSuite[TapTestSame[HoldComplete[1 + 1, Evaluate[1 + 2], Sequence[3, 4]], 
...
RefLink[HoldAllComplete,paclet:ref/HoldAllComplete]:"], 
 ...
 TapTestSame[HoldComplete[g[1]], HoldComplete[g[1]]], 
 TapComment["Substitution still happens inside \
...
evaluation:"], TapTestSame[Hold[1 + 2], Hold[1 + 2]], 
 ...
 TapTestSameBROKEN[Hold[g[1]], 1], TapComment["RefLink[HoldComplete,paclet:re\
f/HoldComplete] can be used to freeze the result of \
RefLink[ToExpression,paclet:ref/ToExpression] before it is evaluated:"], 
 TapTestSame[ToExpression["Sequence[a,b]", InputForm, HoldComplete], 
  HoldComplete[Sequence[a, b]]], TapComment["RefLink[HoldComplete,paclet:ref/\
HoldComplete] affects only evaluation; input transformations are still \
applied:"], TapTestSameBROKEN[FullForm[HoldComplete[a - b, a/b]], 
