...
RefLink[TraditionalForm,paclet:ref/TraditionalForm] of an expression:"], 
 ...
 TapTestSameBROKEN[ToString[x^2 + y^3, StandardForm], x^2 + y^3], 
 TapTestSameBROKEN[ToString[x^2 + y^3, TraditionalForm], x^2 + y^3], 
 TapComment["Non-default character encoding:"], 
 TapTestSameBROKEN[ToString[\[Alpha], StandardForm], \[Alpha]], 
 ...
 TapTestSameBROKEN[ToString[\[Alpha]], \[Alpha]], 
...
RefLink[InputForm,paclet:ref/InputForm] formatting:"], 
 TapTestSameBROKEN[ToString[1.2, InputForm], 1.2], 
 ...
 TapTestSameBROKEN[ToString[Cos[x] + Cos[y]], Cos[x] + Cos[y]], 
 ...
 TapTestSameBROKEN[v = ({#1, #1[1.]} & ) /@ {Sin, Cos, Tan, Cot, Exp}, 
  {{Sin, 0.841471}, {Cos, 0.540302}, {Tan, 1.55741}, {Cot, 0.642093}, 
   {Exp, 2.71828}}], TapTestSameBROKEN[(StringTake[#1, -7] & ) /@ ofiles, 
...
strings or boxes to expressions:"], TapTestSameBROKEN[
  ToString[x^3, StandardForm], x^3], TapTestSameBROKEN[ToExpression[%], x^3], 
 TapComment[
...
RefLink[MakeBoxes,paclet:ref/MakeBoxes]:"], 
 TapTestSameBROKEN[ToString[kappa], kappa], 
 TapTestSameBROKEN[ToString[kappa], \[Kappa]], 
 TapTestSameBROKEN[ToString[gplus[a, b, c], StandardForm], gplus[a, b, c]], 
 TapTestSameBROKEN[HoldComplete[ToString[gplus[a, b, c], StandardForm]], 
  $Failed], TapComment["RefLink[ToString,paclet:ref/ToString] by default uses \
RefLink[OutputForm,paclet:ref/OutputForm] formatting: "], 
 ...
 TapTestSameBROKEN[ToString[u + Style[i, Red], TraditionalForm], i + u]]
