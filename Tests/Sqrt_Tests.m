...
TapSuite[TapTestSame[Sqrt[2], Sqrt[2]], 
 TapComment["Evaluate numerically to any precision:"], 
 TapTestSame[N[Sqrt[2], 50], 
 ...
 TapTestSameBROKEN[HoldComplete[Plot[Sqrt[x], {x, 0, 10}]], $Failed], 
 ...
 TapTestSameBROKEN[Sqrt[2.5 + I], 1.6113 + 0.310308*I], 
 ...
 TapTestSame[ContinuedFraction[Sqrt[19], 20], {4, 2, 1, 3, 1, 2, 8, 2, 1, 3, 
   1, 2, 8, 2, 1, 3, 1, 2, 8, 2}], TapTestSameBROKEN[
...
negative real axis:"], TapTestSameBROKEN[{Sqrt[-1 + 0.01*I], 
