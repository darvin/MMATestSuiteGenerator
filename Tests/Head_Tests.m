...
TapSuite[TapTestSame[Head[f[a, b]], f], TapTestSame[Head[a + b + c], Plus], 
 TapTestSame[Head[{a, b, c}], List], TapTestSame[Head[45], Integer], 
 TapTestSame[Head[x], Symbol], TapComment["Heads need not be symbols:"], 
 TapTestSame[Head[f[x][y][z]], f[x][y]], 
 TapComment[
