...
TapSuite[TapTestSame[k = 1; k += 5, 6], TapTestSame[k, 6], 
 TapComment["Add to a numerical value:"], TapTestSame[x = 1.5; x += 3.75; x, 
  5.25], TapComment["Add to a symbolic value:"], 
 TapTestSame[v = a; v += b; v, a + b], 
 TapComment["Add to all values in a list:"], TapTestSame[x = {1, 2, 3}, 
  {1, 2, 3}], TapTestSame[x += 17; x, {18, 19, 20}], 
 TapTestSame[x += {20, 21, 22}; x, {38, 40, 42}], 
...
f/PreIncrement] is a special case of RefLink[AddTo,paclet:ref/AddTo]:"], 
 ...
 TapTestSameBROKEN[AppendTo[list, 4]; list, {1, 2, 3, 4}], 
