...
, TapTestSame[Map[h, \[LeftAssociation] 
 ...
 TapTestSame[HoldComplete[Map[f, {{{{{a}}}}}, {0, Infinity}]], $Failed], 
 TapComment["Negative levels:"], TapTestSame[Map[f, {{{{{a}}}}}, -1], 
  {f[{f[{f[{f[{f[a]}]}]}]}]}], TapTestSame[Map[f, {{{{{a}}}}}, -2], 
  {f[{f[{f[{f[{a}]}]}]}]}], TapTestSame[Map[f, {{{{{a}}}}}, -3], 
  {f[{f[{f[{{a}}]}]}]}], TapComment[
