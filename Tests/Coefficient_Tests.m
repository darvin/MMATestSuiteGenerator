...
TapSuite[TapComment["Find coefficients of polynomials:"], 
 ...
 TapTestSameBROKEN[CoefficientList[f, x], {243, 405, 270, 90, 15, 1}], 
...
RefLink[Exponent,paclet:ref/Exponent]:"], 
 TapTestSameBROKEN[(Coefficient[f, x, #1] & ) /@ Range[0, Exponent[f, x]], 
  {243, 405, 270, 90, 15, 1}], TapTestSameBROKEN[
  cl = CoefficientList[f, {x, y}], {{0, 0, 0, 0, 625}, {0, 0, 0, 1500, 0}, 
   {0, 0, 1350, 0, 0}, {0, 540, 0, 0, 0}, {81, 0, 0, 0, 0}}], 
 TapComment["RefLink[CoefficientArrays,paclet:ref/CoefficientArrays] gives \
the list of arrays of polynomial coefficients ordered by total degree:"], 
