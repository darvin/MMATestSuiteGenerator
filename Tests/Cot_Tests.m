...
not simplify automatically:"], TapTestSame[Cot[z] + Tan[z], Cot[z] + Tan[z]], 
 ...
 TapTestSame[FindRoot[Cot[z]^2 + 3*Cot[z + Pi/6] + z == 4, {z, 2}], 
...
in special cases of many mathematical functions: "], 
 ...
 TapTestSameBROKEN[N[Cot[10^30], 20], 
  11.051547193404474785`19.043423082593154], TapComment["A larger setting for \
RefLink[$MaxExtraPrecision,paclet:ref/$MaxExtraPrecision] is needed:"], 
 TapTestSameBROKEN[N[Cot[10^100], 20], 0.*10^30], 
 TapTestSameBROKEN[Block[{$MaxExtraPrecision = 200}, N[Cot[10^100], 20]], 
  2.4923238792798206949`19.39660447853459], 
 TapTestSame[$Failed, HoldComplete[Csc[n*z]*Sin[n*(Pi/2 + z)]*Tan[z]]], 
 ...
 TapTestSame[HoldComplete[ArrayPlot[Table[ArcCot[Abs[Cot[x*y]]], 
