...
TapSuite[TapComment["Join strings:"], TapTestSameBROKEN[
  StringJoin["abcd", "ABCD", "xyz"], abcdABCDxyz], 
 TapComment[
  "Use RefLink[InputForm,paclet:ref/InputForm] to show string quotes:"], 
 TapTestSameBROKEN[InputForm[%], "abcdABCDxyz"], 
 TapComment["All lists are ignored:"], TapTestSameBROKEN[
...
information embedded in strings:"], TapTestSameBROKEN[
  StringJoin["red", "blue"], redblue], 
 TapComment["Iteratively join a string to its reverse:"], 
 TapTestSameBROKEN[NestList[StringJoin[#1, StringReverse[#1]] & , "AB", 5], 
 ...
 TapTestSameBROKEN[data = Partition[Characters["aabcaabc"], 3, 1], 
  {{a, a, b}, {a, b, c}, {b, c, a}, {c, a, a}, {a, a, b}, {a, b, c}}], 
 TapTestSameBROKEN[StringJoin /@ data, {aab, abc, bca, caa, aab, abc}], 
...
inverse to RefLink[Characters,paclet:ref/Characters]:"], 
 TapTestSameBROKEN[Characters["abcdefg"], {a, b, c, d, e, f, g}], 
