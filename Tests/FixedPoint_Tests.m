...
TapSuite[TapComment["Find a value x such that x^2=2:"], 
 TapTestSameBROKEN[FixedPoint[(#1 + 2/#1)/2 & , 1.], 1.41421], 
 TapTestSameBROKEN[Sqrt[2.], 1.41421], 
 ...
 TapTestSameBROKEN[FixedPoint[Erf, 1.], 0.617447], 
 ...
 TapTestSameBROKEN[FixedPoint[Log, 1. + I], 0.318132 + 1.33724*I], 
...
info,http://www.wolframscience.com/nksonline/page-1122]]:"], 
 ...
 TapTestSameBROKEN[ConnectedNodes[{{3, 2}, {4, 3}, {5, 4}, {1, 5}, {2, 1}}, 
   1], {1, 2, 3, 4, 5}], TapComment["RefLink[FixedPoint,paclet:ref/FixedPoint\
] gives the last element of \
RefLink[FixedPointList,paclet:ref/FixedPointList]:"], 
 TapTestSameBROKEN[FixedPointList[Function[x, (x + 2/x)/2], 1.], 
  {1., 1.5, 1.41667, 1.41422, 1.41421, 1.41421, 1.41421}], 
 TapTestSameBROKEN[FixedPoint[Function[x, (x + 2/x)/2], 1.], 1.41421], 
...
particular choice of arguments of RefLink[NestWhile,paclet:ref/NestWhile]:"], 
 TapTestSameBROKEN[NestWhile[Function[x, (x + 2/x)/2], 1., UnsameQ, 2], 
  1.41421], TapComment[
...
larger tolerance:"], TapTestSameBROKEN[FixedPoint[Cos, 0.5, 
   SameTest -> Equal], 0.739085]]
