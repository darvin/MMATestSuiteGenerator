...
ESimpleExamples[EComment[
 ...
 ESameTest[k = 1; --k, 0], ESameTest[k, 0], 
 ...
 ESameTest[i = 10^6; While[ !PrimeQ[--i], Null]; i, 999983], 
 ESameTestBROKEN[{a--, --b}, {1, 0}], ESameTestBROKEN[{a, b}, {0, 0}], 
 EComment["RefLink[PreDecrement,paclet:ref/PreDecrement] is a short form of \
this assignment:"], ESameTest[k = 1; k = k - 1, 0], 
