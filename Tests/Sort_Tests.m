...
RefLink[Association,paclet:ref/Association] according to their values:"], 
 ...
 TapTestSame[Sort[{"cat", "fish", "catfish", "Cat"}], 
 ...
 TapTestSame[Sort[{"aa", "abb", "ba", "b", "aaa"}], {aa, aaa, abb, b, ba}], 
 TapComment["Sort strings by length:"], 
 TapTestSame[Sort[{"aa", "abb", "ba", "b", "aaa"}, 
...
same order as RefLink[Sort,paclet:ref/Sort]:"], 
 ...
 TapTestSameBROKEN[Reap[Sort[{4, 1, 3, 2}, (Sow[{#1, #2}]; #1 > #2) & ]], 
  {{4, 3, 2, 1}, {{{4, 1}, {1, 3}, {4, 1}, {3, 2}, {4, 3}, {1, 3}, 
     {1, 2}}}}], TapComment["RefLink[Sort,paclet:ref/Sort][list] is \
equivalent to list[[RefLink[Ordering,paclet:ref/Ordering][list]]]:"], 
 TapTestSameBROKEN[list = RandomInteger[10, 10] ;; Sort[list], 
  {0, 0, 1, 3, 3, 6, 6, 7, 8, 10}], TapTestSameBROKEN[list[[Ordering[list]]], 
