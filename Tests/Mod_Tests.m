...
TapSuite[TapComment["Remainders mod 3:"], 
 ...
 TapTestSameBROKEN[HoldComplete[DiscretePlot[Mod[n, 8], {n, 50}]], $Failed], 
 TapComment["Plot the sequence, varying the modulus: "], 
 TapTestSameBROKEN[HoldComplete[DiscretePlot[Mod[100, m], {m, 50}]], 
  $Failed], TapComment["Reduce an approximate number:"], 
 TapTestSameBROKEN[Mod[4.56, 2], 0.56], 
 ...
 TapTestSameBROKEN[(1 \[CirclePlus] 0) \[CirclePlus] 1, 0], 
 ...
 TapTestSameBROKEN[HoldComplete[Plot[Mod[x, 2], {x, -6, 6}]], $Failed], 
...
1801641201490284097309096322681531675707666695323797578126 + 
   GoldenRatio^1000], TapTestSameBROKEN[
  HoldComplete[ArrayPlot[Table[Mod[i, j], {i, 30}, {j, 30}]]], $Failed], 
 TapComment["Binomial coefficients mod 2:"], 
 TapTestSameBROKEN[HoldComplete[ArrayPlot[Table[Mod[Binomial[i, j], 2], 
     {i, 0, 63}, {j, 0, 63}]]], $Failed], 
 TapComment["Mod 4 additive cellular automaton:"], 
 TapTestSameBROKEN[HoldComplete[ArrayPlot[CellularAutomaton[
