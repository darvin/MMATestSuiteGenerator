...
TapSuite[TapComment["Minimum of two numbers:"], TapTestSame[Min[9, 2], 2], 
 ...
 TapTestSame[Min[{3, 4, 1}, {2, 2}, 7], 1], TapTestSameBROKEN[Min[mat], -3], 
 TapComment["The minima of all rows:"], TapTestSameBROKEN[Min /@ mat, 
  {-1, 0, -3}], TapComment["The minima of all columns:"], 
 ...
 TapTestSameBROKEN[Reduce[{Min[Sin[x], Cos[x]] > 0, 0 < x < 20}, x], 
