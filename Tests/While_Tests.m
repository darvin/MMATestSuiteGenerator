...
TapSuite[TapComment["The body can be included as part of the test:"], 
 ...
 TapTestSame[n = 1; While[n < 4, n++]; n, 4], TapComment["RefLink[Break,pacle\
t:ref/Break] breaks out of the RefLink[While,paclet:ref/While]:"], 
 TapTestSame[n = 1; While[True, If[n > 10, Break[]]; n++]; n, 11], 
 ...
 TapTestSame[x = 1.; i = 0; While[Cos[x] != x, x = Cos[x]; i++]; {x, i}, 
  {0.739085, 80}], TapComment[
  "RefLink[While,paclet:ref/While] returns RefLink[Null,paclet:ref/Null]:"], 
 TapTestSame[FullForm[n = 1; While[n < 5, n++]], Null], 
