...
TapSuite[TapTestSameBROKEN[$Failed, HoldComplete[
 ...
 TapTestSame[NestList[Cos, 1., 10], {1., 0.540302, 0.857553, 0.65429, 
   0.79348, 0.701369, 0.76396, 0.722102, 0.750418, 0.731404, 0.744237}], 
 ...
 TapTestSame[NestList[Sqrt, 100., 4], {100., 10., 3.16228, 1.77828, 
   1.33352}], TapComment["The nested function can operate on a list:"], 
 TapTestSame[With[{\[Epsilon] = 0.1}, 
...
be put into a list:"], TapTestSame[
 ...
 TapTestSame[NestList[#1*(1 + 0.05) & , 1000, 10], 
 ...
 TapTestSame[NestList[(#1 + 2/#1)/2 & , 1., 5], 
 ...
 TapTestSame[NestList[(4*#1)*(1 - #1) & , N[1/3], 10], 
  {0.333333, 0.888889, 0.395062, 0.955952, 0.168432, 0.56025, 0.98548, 
   0.0572373, 0.215845, 0.677023, 0.874651}], 
 TapComment["Iterates in the 3 n+1 problem:"], 
 ...
 TapTestSame[HoldComplete[ListLinePlot[%]], $Failed], 
 TapComment["Iterated string replacements:"], 
 TapTestSame[NestList[StringReplace[#1, {"A" -> "BA", "B" -> "AB"}] & , "A", 
   5], {A, BA, ABBA, BAABABBA, ABBABAABBAABABBA, 
...
second arguments from a list:"], TapTestSame[NestList[f[#1, a] & , x, 3], 
 ...
 TapTestSame[NestList[p[#1][#1] & , x, 3], {x, p[x][x], p[p[x][x]][p[x][x]], 
   p[p[p[x][x]][p[x][x]]][p[p[x][x]][p[x][x]]]}], 
 TapTestSameBROKEN[HoldComplete[NestList[Subsuperscript[#1, #1, #1] & , x, 
    4]], $Failed]]
