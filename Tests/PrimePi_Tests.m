...
but gives integer values:"], TapTestSame[PrimePi[10.1], 4], 
 TapTestSame[HoldComplete[Plot[PrimePi[n], {n, 0, 20}]], $Failed], 
 TapComment[
 ...
 TapTestSameBROKEN[FormBox[TemplateBox[{n}, PrimePi], TraditionalForm], 
  Pi*n], TapTestSame[HoldComplete[Plot[PrimePi[n], {n, 0, 100}]], $Failed], 
 TapComment[
  "Plot RefLink[PrimePi,paclet:ref/PrimePi] compared with estimates:"], 
 TapTestSame[HoldComplete[Plot[{PrimePi[n], n/Log[n], LogIntegral[n], 
...
inverse of RefLink[PrimePi,paclet:ref/PrimePi]:"], 
 TapTestSame[PrimePi[997], 168], TapTestSame[Prime[%], 997], 
